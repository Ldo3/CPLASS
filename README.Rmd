...
output:
  html_document:
    theme: flatly  # Other options: cerulean, journal, readable, spacelab, etc.
    highlight: tango
    toc: true
    toc_float: true
    ...
    df_print: paged
    code_folding: hide
    css: style.css  # Optional, if you want to add custom styles
---
...
In this rmarkdown file, we introduce CPLASS algorithm for detecting change in velocities.

# Call function and load package
```{r call function, warning=FALSE}
